...
class _OffersBoxScreenState extends State<OffersBoxScreen> {
  // +++ تم تحديث المتغيرات لتناسب حقول النطاق +++
                            ...
                            children: [
                              Expanded(
                                child: _buildRangePickerField(
                                  ...
                                  fromValue: _yearFrom, toValue: _yearTo, 
                                  unit: "", isFilter: true,
                                  onTap: () async {
                              ...
                              Expanded(
                                child: _buildRangePickerField(
                                  context, 
                                  title: S.of(context).km, 
                                  fromValue: _kmFrom, toValue: _kmTo, 
                                  unit: "KM", isFilter: true,
                                  onTap: () async {
                                     final result = await _showRangePicker(context, title: S.of(context).km, initialFrom: _kmFrom, initialTo: _kmTo, unit: "KM");
                                      if (result != null) {
                                        setState(() { _kmFrom = result['from']; _kmTo = result['to']; });
                                      }
                                  }
                                ),
                              ),
                              ...
                              Expanded(
                                child: _buildRangePickerField(
                                  ...
                                  fromValue: _priceFrom, toValue: _priceTo, 
                                  unit: "AED", isFilter: true,
                                  onTap: () async {
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Text(displayText, style: TextStyle(
              ...
              fontSize: 10.5), // تم تعديل حجم الخط ليتناسب مع التصميم
