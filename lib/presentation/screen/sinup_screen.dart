  ...
  Future<void> _submitSignUp() async {
    ...
    if (!isChecked) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(S.of(context).agreeTermsValidation), backgroundColor: Colors.orange));
      return;
    }
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(S.of(context).accountCreatedSuccessfully), backgroundColor: Colors.green));
      context.go('/home');
    } else {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(authProvider.errorMessage ?? S.of(context).unknownError), backgroundColor: Colors.red));
    }
  }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Image.asset('assets/images/logo.png', fit: BoxFit.contain, height: 85.h, width: 125.w),
                ),
                SizedBox(height: 5.h),
                Center(
                  child: Text(
                    ...
                    style: TextStyle(color: KTextColor, fontSize: 22.sp, fontWeight: FontWeight.w500),
                  ),
                ),
                SizedBox(height: 5.h),
                Text(
                ...
                Stack(
                  children: [
                    ...
                    IgnorePointer(
                      child: TextFormField(
                        controller: _phoneController,
                        validator: (v) => v!.isEmpty ? S.of(context).pleaseEnterPhone : null,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      CustomTextField(
                        ...
                        validator: (value) {
                          if (showEmailField && (value == null || !value.contains('@'))) {
                ...
                CustomTextField(controller: _referralController, hintText: S.of(context).optional),
                Row(
                  children: [
                    Checkbox(
                      value: isChecked,
                ...
                if (authProvider.isLoading)
                  ...
                  CustomButton(text: S.of(context).register, ontap: _submitSignUp),
                SizedBox(height: 4.h),
                Center(
                  child: Text(
                    S.of(context).or,
