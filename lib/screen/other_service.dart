...
class _OtherServiceScreenState extends State<OtherServiceScreen> {
  int _selectedIndex = 7; // ✅ Real Estate مفعل تلقائيًا
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 6.w),
                          Text(
                            S.of(context).discover_service_offers,
                            style: TextStyle(
                      ...
                      SizedBox(height: 3.h),
                      _buildDropdown(S.of(context).section_type),
                      SizedBox(height: 4.h),
                      Padding(
                        padding:
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: Text(
                                    S.of(context).click_daily_servir_offers,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: KTextColor,
                                      fontWeight: FontWeight.w500,
