...
class _RestaurantsScreenState extends State<RestaurantsScreen> {
  int _selectedIndex = 6; // ✅ Real Estate مفعل تلقائيًا
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 6.w),
                          Text(
                            S.of(context).discover_restaurants_offers,
                            style: TextStyle(
                      ...
                      SizedBox(height: 3.h),
                      _buildDropdown(S.of(context).district_choose),
                      SizedBox(height: 3.h),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: Text(
                                    S.of(context).click_daily_offers,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: KTextColor,
                                      fontWeight: FontWeight.w500,
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Padding(
                                      padding: EdgeInsetsDirectional.only(
                                        end: index == RestaurantDataDammy.length - 1
                                            ? 0
