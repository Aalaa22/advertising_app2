...
class _RealEstateScreenState extends State<RealEstateScreen> {
  int _selectedIndex = 1; // ✅ Real Estate مفعل تلقائيًا
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 6.w),
                          Text(
                            S.of(context).discover_real_estate,
                            style: TextStyle(
                      ...
                      SizedBox(height: 3.h),
                      _buildDropdown(S.of(context).district),
                      SizedBox(height: 4.h),
                      _buildDropdown(S.of(context).property_type),
                      SizedBox(height: 3.h),
                      _buildDropdown(S.of(context).contract_type),
                      SizedBox(height: 4.h),
                      Padding(
                        padding:
                        ...
                        child: GestureDetector(
                          onTap: () {
                            context.push('/real_estate_search');
                          },
                          child: Container(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    S.of(context).click_for_deals_real_estate,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: KTextColor,
                                      fontWeight: FontWeight.w500,
