...
class OtherServiceSearchScreen extends StatefulWidget {
  ...
  @override
  State<OtherServiceSearchScreen> createState() => _OtherServiceSearchScreenState();
}
...
class _OtherServiceSearchScreenState extends State<OtherServiceSearchScreen> {
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 4.w),
                          Expanded(child: _buildFilterChip(S.of(context).service)),
                          SizedBox(width: 4.w),
  ...
  Widget build(BuildContext context) {
    ...
    for (var car in OtherServiceDammyData) {
      switch (car.priority) {
        ...
        children: [
          Expanded(
            child: Text(
              ...
              overflow: TextOverflow.ellipsis,
              style: TextStyle(fontSize: 10.3.sp, color: KTextColor, fontWeight: FontWeight.w400),
            ),
          ),
          SizedBox(width: 2.w),
    ...
    return GestureDetector(
      ...
      child: Directionality(
        ...
        child: SearchCard(
          ...
          onDelete: () {
            setState(() {
              OtherServiceDammyData.remove(item);
            });
          },
        ),
      ),
