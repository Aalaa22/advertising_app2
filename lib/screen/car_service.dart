                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CustomCategoryGrid(
                      ...
                      selectedIndex: _selectedIndex, // ✅ تمرير selectedIndex
                      onTap: (index) {
                        setState(() {
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 6.w),
                            Text(
                              S.of(context).discover_car_service,
                              textAlign: TextAlign.start,
                              style: TextStyle(
                        ...
                        SizedBox(height: 3.h),
                        _buildDropdown(S.of(context).service_type),
                        SizedBox(height: 4.h),
                        Padding(
                          padding:
                        ...
                        Padding(
                          padding:
                              EdgeInsetsDirectional.symmetric(horizontal: 8.w),
                          child: GestureDetector(
                            onTap: () => context.push('/carservicetofferbox'),
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      S.of(context).click_for_deals_car_service,
                                      textAlign: TextAlign.start,
                                      style: TextStyle(
                                        fontSize: 13.sp,
                                        color: KTextColor,
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return Padding(
                                        ...
                                        end: index == CarServiceDataDummy.length - 1
                                            ? 0
